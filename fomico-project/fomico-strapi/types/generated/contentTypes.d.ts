...
export interface ApiJobJob extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    requirements: Schema.Attribute.Component<'product.feature', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    type: Schema.Attribute.Enumeration<['CDI', 'CDD', 'Stage', 'Freelance']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Catalogue produits FOMICO';
    displayName: 'Produit';
    pluralName: 'products';
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    location: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    results: Schema.Attribute.Component<'product.feature', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiQuoteRequestQuoteRequest
  ...
  attributes: {
    ...
    message: Schema.Attribute.Text & Schema.Attribute.Required;
    nom: Schema.Attribute.String & Schema.Attribute.Required;
    produit: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    quantite: Schema.Attribute.String & Schema.Attribute.Required;
    societe: Schema.Attribute.String & Schema.Attribute.Required;
    status: Schema.Attribute.Enumeration<
      ['Nouveau', 'En cours', 'Trait\u00E9', 'Archiv\u00E9']
    > &
      Schema.Attribute.DefaultTo<'Nouveau'>;
...
export interface ApiSectorSector extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    challenges: Schema.Attribute.Component<'product.feature', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'title'> & Schema.Attribute.Required;
    solutions: Schema.Attribute.Component<'product.feature', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiSettingSetting extends Struct.SingleTypeSchema {
  ...
  info: {
    displayName: 'Param\u00E8tres globaux';
    pluralName: 'settings';
  ...
  attributes: {
    ...
    companyName: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'FOMICO Industries'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    email: Schema.Attribute.Email;
    ...
    publishedAt: Schema.Attribute.DateTime;
    socialLinks: Schema.Attribute.Component<'product.feature', true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
